...
import {changeTheme} from '../../Store/index';
...
const SwitchThumb = styled('span')(
  ...
  position: absolute;
  display: block;
  background-color: ${theme.palette.mode === 'dark' ? '#080808' : '#585858'};
  width: 32px;
  height: 32px;
  border-radius: 16px;
  top: 1px;
...
const SwitchTrack = styled('span')(
  ({ theme }) => `
  background-color: ${theme.palette.mode === 'dark' ? '#000000' : '#aab4be'};
  border-radius: 10px;
  width: 100%;
  height: 100%;
  display: block;
...
function MUISwitch(props) {
  ...
  return (
    <SwitchRoot className={clsx(stateClasses)} onClick={()=>dispatch(changeTheme())}>
      <SwitchTrack>
